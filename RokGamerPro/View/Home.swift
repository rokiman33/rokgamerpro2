...
struct PantallaHome:View{
    ...
    func busqueda(){
        print("El usuario esta buscando el texto de busqueda")
    }
    
    struct SubModuloHome:View{
        
        
        @State var url = "https://cdn.cloudflare.steamstatic.com/stream/apps/256658589/movie480.mp4"
                        ...
                        print("URL:\(url)")
                            isPlayerActive = true},label:{
                                VStack(spacing: 0){
                                    ...
                                    Text("The Witcher 3").frame(minWidth: /*@START_MENU_TOKEN@*/0/*@END_MENU_TOKEN@*/, maxWidth: /*@START_MENU_TOKEN@*/.infinity/*@END_MENU_TOKEN@*/,
                                                               alignment: .leading)
                                        .background(Color("Blue-Gray"))
                                }
                            })
